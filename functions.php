...
if ( !function_exists('maidesign_theme_setup') ) {
	...
	function maidesign_theme_setup() {
		...
		add_image_size( 'misc-thumb', 320, 0, false );	
...
function maidesign_load_scripts() {
  ...
  wp_register_script('slick-js', get_template_directory_uri() . '/js/slick.min.js', 'jquery', '', true);
  ...
  wp_enqueue_style('slick-theme');
	...
	wp_enqueue_style('default_sub_heading_font', 'https://fonts.googleapis.com/css?family=Raleway:400,600,700,800');	
    wp_enqueue_style('default_heading_font', 'https://fonts.googleapis.com/css?family=Merriweather:400,400italic,700,700italic');    
    
    if(get_theme_mod( 'md_font_style' ) == "montserrat") :  
    wp_enqueue_style('default_heading2_heading_font', 'https://fonts.googleapis.com/css?family=Montserrat:400,700');
    endif;
