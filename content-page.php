<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>   
    ...
    <div class="post-header">
            ...
            <div class="post-meta">   
        		...
        		<?php if(!get_theme_mod('md_page_date')) : ?>
                <div class="meta_date">
        		<?php the_time( get_option('date_format') ); ?>
                </div>
        		<?php endif; ?>       		
                
        		<?php if(!get_theme_mod('md_page_author_name')) : ?>
                <span class="by">by</span>    
                <div class="meta_author"><?php the_author_posts_link(); ?></div>
        		<?php endif; ?>
    ...
    <div class="meta_bottom"> 
        ...
        <?php if ( comments_open()) : ?> 
            ...
            <a class="comment_count" href="<?php comments_link(); ?> ">Leave a comment</a>   
